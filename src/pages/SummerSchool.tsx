  ...
  return (
    <>
      ...
      <div className="overflow-hidden">
        <div className="container flex flex-col md:flex-row items-center justify-between pt-32 md:pt-[9.375rem] pb-[4.11625rem]">
            <div className="" >
              <h2 className="md:text-5xl text-2xl  text-center md:text-left font-bold text-[#3E4C57] mb-[1.3125rem] md:mb-6 md:leading-[3.75rem]">
                <p>Ignite your Child’s</p>
                <span ref={typedRef}></span>
              </h2>
              <p className="md:text-[1.5rem] text-[0.875rem] text-center md:text-left mb-[0.9375rem] md:mb-[6rem] font-medium leading-8 max-w-[40.125rem]" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">Xapictech kids summer tech school program is designed for young minds eager to learn, create, and innovate. </p>
    ...
    <div className="bg-[#FCFCFF] overflow-hidden">
        <div className="container pt-[3.25rem] md:pt-[3.75rem] pb-[3rem]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-[3.25rem] md:mt-[3.75rem]">
      ...
      <div className="container flex flex-col md:flex-row items-center gap-[3.6875rem] pt-[3.75rem]">
        <div className="max-w-[40.25rem] text-center md:text-left" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
          ...
          <button className="buttonScaleUp w-[11.375rem] mt-8 mx-auto md:ml-0">Contact us</button>
        </div>
      ...
      {/* fourthSection */}
        ...
        {/* Fifth Section */}
          <div className="bg-[#00011B] h-[25.0625rem] md:h-[30.5rem]">
            <div className="overflow-hidden container h-full relative pt-[1.5625rem] flex flex-col md:flex-row justify-between items-center  mt-[3.75rem]">
              <div className="max-w-[47.6875rem] text-white" data-aos="fade-right" data-aos-duration="1000" data-aos-delay="200">
                ...
                <button className="button group relative md:w-[13.9375rem] w-[6.875rem] md:mt-[1.5rem] mt-[1rem] border-[1px] border-[#F2F2F2CC]">
                  <span className="relative h-full w-full flex justify-center items-center z-1 hover:text-white">Enroll now</span>
                   <span className="absolute top-0 left-0 flex items-center justify-center border-[1px] border-white h-full w-full text-wite bg-[#00011B] origin-left transition-transform duration-300 scale-x-0 group-hover:scale-x-100"></span>
                </button>
              </div>
