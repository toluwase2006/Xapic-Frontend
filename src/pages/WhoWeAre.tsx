...
const WhoWeAre = () => {
  ...
  return (
     <>
      {/* heroSection */}
      <div className="container pt-[17rem]">
        <div className="flex items-center justify-between text-[#3E4C57]">
          <div className="text-5xl font-semibold leading-14">
            <p>Reshaping the</p>
            <div className="flex items-center">
              <p>Future Through</p>
              <p className="h-[1.0625rem] w-[10.125rem] bg-[#00011B]"></p>
            </div>
            <p>Simplified Technology</p>
          </div>
          <p className="text-[1.75rem] font-medium max-w-[40.1875rem] leading-[2.625rem]">
        ...
        <div className="flex gap-[0.9375rem] mt-[4.4375rem]">
          <div>
            ...
            <div className="flex justify-between mt-[0.625rem]">
              <div className="w-[9.125rem] h-[21.6875rem] bg-[#FE338C]"></div>
              <div className="w-[18.25rem] overflow-hidden h-[19.1875rem] relative">
                <div className="w-full h-full">
                  <img src={heroImage2} alt="" className="hover:scale-105 transition-all duration-500" />
                </div>
                <div className="absolute bottom-0 left-0">
                  <button className="button w-[12.375rem]">
                    <p>View openings</p>
      ...
      <div className="container flex gap-[3.125rem] bg-[#FFCCE226] pt-[4.125rem] pb-[2.75rem] mt-[5.1875rem]">
        <div className="max-w-[24.4375rem] ">
          <div className="flex items-center mb-[1.375rem]">
            ...
            <p className="text-[1.25rem] ">WHO WE ARE</p>
          </div>
          <div className="max-w-[19.4375rem] leading-14">
            <p className="text-[2.5rem] font-bold">Xapic Founding Story</p>
          </div>
        </div>
        <div className="max-w-[48.625rem]">
          <p className="text-[1.75rem] leading-[2.625rem]">Xapictech was founded out of a passion for bridging the technology gap in Africa and empowering individuals through education. Our journey began when a group of tech enthusiasts recognized the immense potential of local talent and the pressing need for innovative software solutions tailored to our unique challenges.</p>
        </div>
      </div>

      {/* Third Section */}
      <div className="container mt-[5.125rem] bg-[#044B651A] pt-[7.5rem] pe-[6.0625rem] ps-[2.6875rem] gap-[1.875rem] pb-[10.1875rem]  grid grid-cols-3">
        <div className="">
          <div className="flex items-center mb-[1.375rem]">
            <div className="w-[1.37625rem] border-[3px] boder-[#00036A]"></div>
            <p className="text-[1.25rem] font-bold">OUR VALUE</p>
          </div>
           <div className="max-w-[10.9375rem] leading-14">
            <p className="text-[2.5rem] font-semibold">The Core of Xapic</p>
          </div>
        </div>
        <div className="">
          <IntegrityIcon className="w-12 h-12 mb-6" />
          <p className="text-[1.75rem] font-bold mb-[1rem]">Integrity</p>
          <p className="text-[1.25rem] font-medium leading-7 mt-4">Integrity is the foundation of our relationships with clients, partners, and team members. We believe in doing the right thing, even when it’s difficult, and we take responsibility for our action</p>
        </div>
        <div className="">
          <IntegrityIcon className="w-12 h-12 mb-6" />
          <p className="text-[1.75rem] font-bold mb-[1rem]">Innovation</p>
          <p className="text-[1.25rem] font-medium leading-7 mt-4">Innovation drives us to continuously improve and adapt in a fast-paced digital landscape.</p>
        </div>
        <div className=" mt-[1.875rem]">
          <IntegrityIcon className="w-12 h-12 mb-6" />
          <p className="text-[1.75rem] font-bold mb-[1rem]">Empowerment</p>
          <p className="text-[1.25rem] font-medium leading-7 mt-4">We believe that everyone should have the opportunity to learn, grow, and thrive. This we do by By providing accessible training programs and resources needed to succeed in the digital age.</p>
        </div>
        <div className=" mt-[1.875rem]">
          <IntegrityIcon className="w-12 h-12 mb-6" />
          <p className="text-[1.75rem] font-bold mb-[1rem]">Collaboration</p>
          <p className="text-[1.25rem] font-medium leading-7 mt-4">Teamwork is at the heart of our success. We foster a collaborative environment where diverse ideas and perspectives are valued.</p>
        </div>
        <div className=" mt-[1.875rem]">
          <IntegrityIcon className="w-12 h-12 mb-6" />
          <p className="text-[1.75rem] font-bold mb-[1rem]">Excellence</p>
          <p className="text-[1.25rem] font-medium leading-7 mt-4">Our commitment to quality ensures that we deliver exceptional products and services that exceed expectations. We continuously seek improvement and take pride in our work, aiming for the highest achievements in the tech industry.</p>
        </div>
      </div>
          ...
          {teamBios.map((teamBio) => (
            ...
            <div className="mt-[4.3125rem]">
              ...
              <div className="mt-[1rem]">
                <p className="underline text-[#00036A] font-semibold text-[1.25rem]">Join the Team</p>
              </div>
            </div>
        </div>
      </div>
