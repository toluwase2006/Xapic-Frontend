...
import heroSectionImage from "../assets/images/Group 30 (2).webp"
...
import GridImage from "../assets/images/Group (1).webp"
...
const Engineering = () => {
  ...
  return (
    <>
        {/* heroSection */}
      <VideoModal />
      <div className="container relative flex items-center justify-between pt-16 md:pt-[7.4375rem] pb-[4.11625rem]">
          <div className="absolute -bottom-7 right-[6.25rem] w-32">
          ...
          <div className="w-[40.25rem]" >
            ...
            <p className="text-[1.5rem] mb-[5.875rem] max-w-[33.0625rem] font-normal leading-8" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">Our cutting-edge programs are designed to equip you with the essential skills and knowledge needed to excel in the ever-evolving engineering landscape</p>
