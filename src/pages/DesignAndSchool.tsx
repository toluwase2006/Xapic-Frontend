      ...
      <div className="overflow-hidden">
        <div className="container flex flex-col md:flex-row items-center justify-between pt-32 md:pt-[9.375rem] pb-[4.11625rem]">
            <div className="max-w-[40.25rem]" >
              ...
              <p className="md:text-[1.5rem] text-[0.875rem] text-center md:text-left mb-[0.9375rem] md:mb-[6.3125rem] font-normal leading-7" data-aos="fade-right" data-aos-delay="200" data-aos-duration="1000">Congratulations on taking this important step towards enhancing your skills and advancing your career! we are dedicated to providing you with an exceptional learning experience that empowers you to achieve your goals</p>
              <div className="flex flex-col md:flex-row gap-[0.9375rem] md:gap-6 items-center" >
                  <button className="buttonScaleUp md:h-[3.5rem] h-[2.5rem] md:text-2xl text-[1rem] font-medium  w-[9.0625rem] md:w-[14.1875rem] gap-[0.625rem]">
                      <p className="md:w-[10.0625rem]">Apply Now</p>
                      <RiArrowRightLine className="w-6 h-6"/>
                  </button>
                  <button className="buttonScaleUp md:text-2xl text-[1rem] md:h-[3.5rem] h-[2.5rem] leading-0 w-[14.9375rem] md:w-[20.3125rem] bg-white border-[1px] border-[#00036A] text-[#00036A] font-medium">
     ...
     {/* SecondSection */}
      ...
      {/* fourthSection */}
        ...
        {/* Fifth Section */}
          ...
          <div className="relative overflow-hidden flex justify-center items-center  h-[19.125rem] md:h-[36.0625rem] bg-[#EBECFF] mt-24">
